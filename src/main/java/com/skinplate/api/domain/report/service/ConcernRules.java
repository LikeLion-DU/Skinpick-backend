 ...
 * 기준선({@code RuleConstants.BASE_SCORE}, 2026-08-20 기준 75)에서 내려가기만 하고 절대
 * 오르지 않아, 잘 챙긴 날에도 화면이 좋아지지 않는다. 반대로 가점만 매달면 무엇을 먹어도
 * 그 기준선 아래로 못 내려가는데, 75 는 GOOD 이라 하루 종일 튀김과 단 것을 먹은 사람의
 * 색소침착 칸이 "좋음"으로 뜬다.
 *
...
public final class ConcernRules {
    ...
    private static final Map<SkinConcern, Set<String>> RULES = Map.of(
            ...
            SkinConcern.DRYNESS,      Set.of("R01", "R08", "R14", "R04"),  // 수분·오메가3 / 나트륨
            ...
            // 두 칸은 기준선(BASE_SCORE) 아래로 내려갈 수 없고, 다른 고민과 도달 범위가 달라 같은
            // 뱃지가 다른 뜻이 된다. 당화·산화는 두 고민이 공유하는 축이다.
            SkinConcern.PIGMENTATION, Set.of("R06", "R08", "R14", "R03", "R12", "R07"),
            SkinConcern.ELASTICITY,   Set.of("R05", "R08", "R14", "R06", "R03", "R12", "R07"),
