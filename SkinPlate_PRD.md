...
### 18.6 룰 정의표 (13종 — 2026-08-18 재캘리브레이션)
...
| **R07** | 튀김(FRIED) 또는 관찰 기름기 HIGH | **−10** × 심각도 (비튀김 ×0.7) | CAUTION | 튀김 조리 / 기름진 음식 | 튀김옷 제거 (+5 · 튀김만) |
...
| **R02** | 홍조(redness>60) × 매운 음식/CAPSAICIN | **−10** × 심각도 × 강도 | CAUTION | 매운맛 자극 | 매운 양념 덜기 (+6) |
...
>
> **회복치는 상수가 아니다.** R04·R10 은 "국물 절반"·"밥 줄이기" 이후의 단계를 계산해 카드에 싣는다.
> 옛 고정값은 나트륨 1,200mg 국에 "+8" 이라 말하고 4 만 올렸고, 1,200kcal 한 끼에 "+5" 라 말하고
> 0 이 올랐다. 회복이 0 이면 행동 카드를 아예 주지 않는다.
>
